...
// eslint-disable-next-line react-refresh/only-export-components
export const actionDoneLabel: Partial<
  Record<AlertItem["severity"], [string, string]>
> = {
      ...
      <div className="flex items-start gap-3 p-3.5">
        <div
          className={cn(
            ...
            alertIconWrapBg[alert.severity],
          )}
        >
          <AlertIcon
            iconType={alert.iconType}
            color={alertIconStroke[alert.severity]}
          />
        </div>
        <div className="flex-1 min-w-0">
          ...
          <p
            className={cn(
              ...
              alertDetailColor[alert.severity],
            )}
          >
            {alert.detail}
          </p>
