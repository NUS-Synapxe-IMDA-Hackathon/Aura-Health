  ...
  return (
    <div className="pb-5">
      ...
      <div className="space-y-2.5 px-4">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          <div className="bg-white rounded-[24px] border border-slate-100 shadow-sm p-4 flex flex-col">
            ...
            <div className="flex items-baseline gap-1 mt-1.5">
              <span className="text-[36px] font-bold leading-none tracking-[-0.03em] text-rose-500">
                {heartRate}
              </span>
          ...
          <div className="bg-white rounded-[24px] border border-slate-100 shadow-sm p-4 flex flex-col">
            ...
            <div className="flex items-baseline gap-1 mt-1.5">
              <span className="text-[36px] font-bold leading-none tracking-[-0.03em] text-blue-500">
                88
              </span>
              <span className="text-[13px] text-slate-400 font-medium">
                / 100
            ...
            <p className="text-[12px] font-semibold text-blue-500 mt-1">
              Good · 8h 00m
            </p>
            <div className="flex-1 min-h-4" />
        ...
        {/* Recent Alerts */}
        <p className="text-[11px] font-bold tracking-[.08em] text-slate-400 uppercase px-1 mt-1">
          Recent Alerts
        </p>
