          ...
          >
            <div className="grid h-24 w-24 place-items-center rounded-full bg-slate-50 text-center">
              <div>
                ...
                <p className="mt-0.5 text-[10px] font-bold tracking-[1px] text-teal-600 uppercase">
                  Good
                </p>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                >
                  ...
                  <p className={`text-sm font-bold text-slate-800 ${tone}`}>
                    {value}
                  </p>
                </div>
              ))}
